...
type User struct {
	...
	RegisterIP  string     `json:"registerIp" gorm:"index"`
...
const (
	GenerationLogKindImage GenerationLogKind = "image"
	GenerationLogKindChat  GenerationLogKind = "chat"
)
...
type GenerationLogList struct {
	Items []GenerationLog `json:"items"`
	Total int             `json:"total"`
}
