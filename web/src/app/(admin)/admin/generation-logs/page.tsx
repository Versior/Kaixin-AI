...
import { Button, Card, Col, Form, Image, Input, List, Modal, Popconfirm, Row, Select, Space, Statistic, Tag, Tooltip, Typography } from "antd";
...
export default function AdminGenerationLogsPage() {
    const { logs, keyword, kind, page, pageSize, total, stats, isLoading, searchLogs, changeKind, changePage, changePageSize, resetFilters, refreshLogs, deleteLog, deletePageLogs } = useAdminGenerationLogs();
