...
import { Button, Card, Col, Form, Image, Input, Modal, Row, Select, Space, Tag, Tooltip, Typography } from "antd";
...
export default function AdminGenerationLogsPage() {
    const { logs, keyword, kind, page, pageSize, total, isLoading, searchLogs, changeKind, changePage, changePageSize, resetFilters, refreshLogs, deleteLog } = useAdminGenerationLogs();
