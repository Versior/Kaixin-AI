...
- 支持单个灵感项目导出为 JSON，也支持从 JSON 导入灵感。
- 灵感项目保存在浏览器本地，登录账号后暂不会自动同步到服务器。

## 灵感事务所

- 支持拖动灵感、滚轮缩放、缩放滑杆和重置视图。
- 支持小地图定位，可开关小地图。
- 支持点阵、网格线、空白三种背景。
- 支持浅色和深色主题。
